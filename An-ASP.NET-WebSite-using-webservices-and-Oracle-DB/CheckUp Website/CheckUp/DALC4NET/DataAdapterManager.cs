...
namespace DALC4NET
{
    ...
    internal class DataAdapterManager
    {
        ...
        /// <summary>
        /// Creates and returns the IDataAdapter for the specified Oracle Command
        /// </summary>
        /// <param name="sqlCommand">Oracle Command</param>
        ...
        /// <summary>
        /// Creates and returns the IDataAdapter for the specified Oracle Command/ Stored Proc
        /// </summary>
        /// <param name="sqlCommand">Oracle Command/ Stored Proc</param>
        /// <param name="connection">Connection</param>
        ...
        /// Creates and returns the IDataAdapter for the specified Oracle Command/ Stored Proc
        /// </summary>
        /// <param name="sqlCommand">Oracle Command/ Stored Proc name</param>
        /// <param name="connection">Connection</param>
        /// <param name="commandType">Type of Command (Text/ StoredProc)</param>
        /// <returns></returns>
