...
{
    /// <summary>
    /// DBHelper class enables to execute Oracle Objects for the connection parameters specified into web.config or App.config file.
    /// </summary>
    public class DBHelper
    {
        ...
        /// <summary>
        /// Executes the Oracle Command or Stored Procedure and returns result.
        /// </summary>
        /// <param name="commandText">Oracle Command or Stored Procedure name</param>
        /// <param name="commandType">Type of command (i.e. Oracle Command/ Stored Procedure name/ Table Direct)</param>
        ...
        /// <summary>
        /// Executes the Oracle Command and returns result.
        /// </summary>
        /// <param name="commandText">Oracle Command</param>
        /// <returns>A single value. (First row's first cell value, if more than one row and column is returned.)</returns>
        ...
        /// <summary>
        /// Executes Oracle Command or Stored procedure and returns number of rows affected.
        /// </summary>
        /// <param name="commandText">Oracle Command or Stored Procedure name</param>
        /// <param name="commandType">Type of command (i.e. Oracle Command/ Stored Procedure name/ Table Direct)</param>
        ...
        /// <summary>
        /// Executes Oracle Command or Stored procedure and returns number of rows effected.
        /// </summary>
        /// <param name="commandText">Oracle Command or Stored Procedure name</param>
        ...
        /// <summary>
        /// Executes Oracle Command and returns number of rows effected.
        /// </summary>
        /// <param name="commandText">Oracle Command</param>
        /// <returns>Number of rows effected.</returns>
        ...
        /// <summary>
        /// Executes Oracle Command and returns number of rows affected.
        /// </summary>
        /// <param name="commandText">Oracle Command</param>
        /// <param name="transaction">Current Database Transaction (Use Helper.Transaction to get transaction)</param>
        /// <returns>Number of rows affected.</returns>
        ...
        /// <summary>
        /// Executes the Oracle Command or Stored Procedure and return resultset in the form of DataSet.
        /// </summary>
        /// <param name="commandText">Oracle Command or Stored Procedure name</param>
        /// <param name="param">Parameter to be associated with the command</param>
        /// <param name="commandType">Type of command (i.e. Oracle Command/ Stored Procedure name/ Table Direct)</param>
        ...
        /// <summary>
        /// Executes the Oracle Command and return resultset in the form of DataSet.
        /// </summary>
        /// <param name="commandText">Oracle Command </param>
        /// <returns>Result in the form of DataSet</returns>
        ...
        /// <summary>
        /// Executes the Oracle Command or Stored Procedure and return resultset in the form of DataTable.
        /// </summary>
        /// <param name="commandText">Oracle Command or Stored Procedure name</param>
        ...
        /// Executes the Oracle Command or Stored Procedure and return resultset in the form of DataTable.
        /// </summary>
        /// <param name="commandText">Oracle Command8 or Stored Procedure name</param>
        /// <param name="paramCollection">Parameter collection to be associated with the Command or Stored Procedure.</param>
        /// <param name="commandType">Type of command (i.e. Oracle Command/ Stored Procedure name/ Table Direct)</param>
        /// <returns>Result in the form of DataTable</returns>
        ...
        /// <summary>
        /// Executes the Oracle Command and return resultset in the form of DataTable.
        /// </summary>
        /// <param name="commandText">Oracle Command</param>
        /// <param name="tableName">Table name</param>
        /// <param name="paramCollection">Parameter collection to be associated with the Command.</param>
        ...
        /// <summary>
        /// Executes the Oracle Command or Stored Procedure and returns the DataReader.
        /// </summary>
        /// <param name="commandText">Oracle Command or Stored Procedure Name</param>        
        ...
        /// <summary>
        /// Executes the Oracle Command and returns the DataReader.
        /// </summary>
        /// <param name="commandText">Oracle Command</param>        
        /// <param name="con">Database Connection object (DBHelper.GetConnObject() may be used)</param>
        /// <returns>DataReader</returns>
        ...
        /// <param name="commandText">Oracle Command or Stored Procedure Name</param>        
        /// <param name="con">Database Connection object (DBHelper.GetConnObject() may be used)</param>
        /// <param name="param">Parameter to be associated with the Oracle Command or Stored Procedure.</param>
        /// <param name="commandType">Type of command (i.e. Oracle Command/ Stored Procedure name/ Table Direct)</param>
        /// <returns>DataReader</returns>
        ...
        /// <param name="commandText">Oracle Command</param>        
        /// <param name="con">Database Connection object (DBHelper.GetConnObject() may be used)</param>
        /// <param name="param">Parameter to be associated with the Oracle Command.</param>
        /// <returns>DataReader</returns>
        ...
        /// <param name="commandText">Oracle Command</param>        
        /// <param name="con">Database Connection object (DBHelper.GetConnObject() may be used)</param>
        /// <param name="paramCollection">Parameter to be associated with the Oracle Command or Stored Procedure.</param>
        /// <returns>DataReader</returns>
        ...
        /// <summary>
        /// Executes the Oracle Command and returns the IDataReader. Do remember to Commit or Rollback the transaction
        /// </summary>
        /// <param name="commandText">Oracle Command</param>
        /// <param name="param">Database Parameter</param>
        ...
        /// <summary>
        /// Executes the Oracle Command or Stored Procedure and returns the IDataReader. Do remember to Commit or Rollback the transaction
        /// </summary>
        /// <param name="commandText">Oracle Command or Stored Proc Name</param>
        /// <param name="param">Database Parameter</param>
        /// <param name="transaction">Database Transaction (Use DBHelper.Transaction property for getting the transaction.)</param>
