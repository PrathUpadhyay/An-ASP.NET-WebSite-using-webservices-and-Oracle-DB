...
(function($) {
	$.fn.multiscroll = function(options) {
		...
		function scrollPage(leftDestination){
			...
			rightDestination.addClass('active').fadeIn(400).siblings().removeClass('active').fadeOut(400);
			leftDestination.addClass('active').fadeIn(400).siblings().removeClass('active').fadeOut(400);
